...
$a_1 = \frac{p_cr}{\tau_1 p_1^2 N q}$, $a_2 = \frac{p_cr}{\tau_2 p_2^2 N q}$, $b = a_1 = \frac{p_cr}{\tau_1 p_1^2 \tau_2 p_2^2 N q}$, $c1 = \frac{p_cr - p_1}{\tau_1 p_1}$, $c2 = \frac{p_cr - p_2}{\tau_2 p_2}$

$q$ - максимальная потребность одного человека в продукте в единицу времени.
$p_cr$ - критическая стоимость продукта.
