...
$$
\ddot{x} + 2\gamma \dot{x} + \omega^2 x = 0, \tag{1}
$$
...
Также может появится внешняя сила, действующая на осцилятор, в этом случае уравнение примет вид:

$$
\ddot{x} + 2\gamma \dot{x} + \omega^2 x = \F(t), \tag{1}
$$
