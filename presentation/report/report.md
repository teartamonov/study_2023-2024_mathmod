...
Формула для расчёта вероятности того, что из урны с $m$ черными шарами и $n$ белыми шарами будет вытянуто $k$ черных шаров для данной модели выглядит следующим образом:
$$
...
больше никогда не появится. [ссылка на вики]
...
Этот фактор и может стать снежным комом. [ссылка на сайт с диаграммой]

[График урны Поля](image/julia_balance.PNG)
...
[График урны Фридмана](image/julia_balance.PNG)
